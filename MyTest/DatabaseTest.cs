    ...
    public class DatabaseTest
    {
        ...
        public void ResetSchema()
        {
            ...
            /*
             ...
             Insert into NBPM_MEMBERSHIP(id,role,type_,user_,group_) values(2,'boss','hierarchy','ae','myTeam')
			 Insert into NBPM_MEMBERSHIP(id,role,type_,user_,group_) values(3,'hr-responsible','hierarchy','ag','myTeam')
             */
        }
    }
}
